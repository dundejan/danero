...
const HOLDINGS: Holding[] = [
  ...
  { tag: 'nflx', ticker: 'NFLX', isin: 'US64110L1061', name: 'Netflix', currency: 'USD', price: '980', buys: [{ y: -4, md: '04-22', qty: '5', price: '220', fee: '1' }], sells: [{ y: -4, md: '10-14', qty: '2', price: '190', fee: '1' }] },
  ...
  { tag: 'pltr', ticker: 'PLTR', isin: 'US69608A1088', name: 'Palantir', currency: 'USD', price: '80', buys: [{ y: -2, md: '05-30', qty: '40', price: '22', fee: '1' }] },

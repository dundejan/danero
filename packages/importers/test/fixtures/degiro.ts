 ...
 * NL popisy. Měny jsou v bezejmenných sloupcích hned za částkou (reálný formát).
 */
...
export const DEGIRO_ACCOUNT_CZ = [
  ...
  '10-01-2024;14:30;12-01-2024;APPLE INC;US0378331005;Nákup 10 Apple Inc@185,5 USD (NSY);1,0775;-1721,63;EUR;8278,37;EUR;abc-123-def',
  '10-01-2024;14:30;12-01-2024;APPLE INC;US0378331005;Konverze měny;1,0775;-1855,00;USD;0,00;USD;',
  '01-02-2024;08:00;01-02-2024;;;Poplatek za připojení na burzu 2024 (Euronext Amsterdam - EAM);;-2,50;EUR;8275,87;EUR;',
  ...
  '01-04-2024;00:05;01-04-2024;;;Úrok;;1,25;EUR;8277,12;EUR;',
  // změna ISIN: párové řádky odpis+připis; odpis má víceřádkový popis v uvozovkách
  '20-05-2024;12:00;20-05-2024;VANGUARD FTSE AW;IE00B3RBWM25;"Změna ISIN: Odpis 3 ks\nnový ISIN IE00BK5BQT80";;;;8277,12;EUR;',
  '20-05-2024;12:00;20-05-2024;VANGUARD FTSE AW;IE00BK5BQT80;Změna ISIN: Připis 3 ks;;;;8277,12;EUR;',
  '01-06-2024;10:00;01-06-2024;;;Výběr;;-500,00;EUR;7777,12;EUR;',
  '03-06-2024;01:00;03-06-2024;;;Degiro Cash Sweep;;100,00;EUR;7877,12;EUR;',
  // informativní řádek s prázdnou Změnou → žádný záznam
  '04-06-2024;09:00;04-06-2024;;;Dividenda;;;;7877,12;EUR;',
].join('\n');

/** NL popisy + čárkový oddělovač (čísla s desetinnou čárkou proto v uvozovkách). */
export const DEGIRO_ACCOUNT_NL = [
  'Datum,Tijd,Valutadatum,Product,ISIN,Omschrijving,FX,Mutatie,,Saldo,,Order Id',
  '02-01-2024,09:00,02-01-2024,,,iDEAL storting,,"1.000,00",EUR,"1.000,00",EUR,',
  '05-01-2024,10:00,05-01-2024,ASML HOLDING,NL0010273215,Dividend,,"10,00",EUR,"1.010,00",EUR,',
  '05-01-2024,10:00,05-01-2024,ASML HOLDING,NL0010273215,Dividendbelasting,,"-1,50",EUR,"1.008,50",EUR,',
  '06-01-2024,02:00,06-01-2024,,,Flatex Interest Income,,"0,10",EUR,"1.008,60",EUR,',
  '07-01-2024,11:00,07-01-2024,ASML HOLDING,NL0010273215,"Koop 2 ASML Holding@600,00 EUR (XEAM)",,"-1.200,00",EUR,"-191,40",EUR,order-nl-1',
  '08-01-2024,12:00,08-01-2024,,,Terugstorting,,"-200,00",EUR,"-391,40",EUR,',
  '09-01-2024,13:00,09-01-2024,,,Rente,,"-0,75",EUR,"-392,15",EUR,',
  // fúze: párové řádky s počty kusů v popisu → ratio 10:5
  '10-02-2024,12:00,10-02-2024,OLD CORP,US1111111117,FUSIE: Uitboeking 10 aandelen OLD CORP,,,,"-392,15",EUR,',
  '10-02-2024,12:00,10-02-2024,NEW CORP,US2222222226,FUSIE: Inboeking 5 aandelen NEW CORP,,,,"-392,15",EUR,',
].join('\n');
